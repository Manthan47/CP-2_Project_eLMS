...
import kotlinx.android.synthetic.main.activity_student_upload_assignment.*
import java.util.*

class StudentUploadAssignmentActivity : AppCompatActivity() {
    val pdf: Int=0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val chooseFile=findViewById<Button>(R.id.chooseAssignmentFile)
        mStorage= FirebaseStorage.getInstance().getReference("Subjects/$title/$title1/Student Assignments")
        ...
        if(uri != null){
            ...
            val urlTask = uploadTask?.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    database = FirebaseDatabase.getInstance().getReference("Subject/$title/StudentAssignments/$title1")

                    val upfacmaterial = StudentUploadAssignment(assignmenttitle, pdfUrl)
